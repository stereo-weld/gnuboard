...
<div class="pb-4 px-3 px-sm-0 font-weight-normal">
	...
	<h2 class="sr-only">사이트 이용안내</h2>

	<h5 class="text-primary font-weight-bold pb-2">1. 사이트 이용시 주의사항</h5>
	...
	<h5 class="text-primary font-weight-bold pt-4 pb-2">2. 포인트 제도 안내</h5>
	...
	<h5 class="text-primary font-weight-bold pt-4 pb-2">3. 게시물 규제정책</h5>

	<p>본 사이트의 게시물 규제정책은 방송통신심의위원회의 SafeNet 등급기준에 대한 연령별 권장사항 중 12세 이상 (중학생가) 레벨을 따르고자 노력합니다.</p>

	<p class="py-2">본 사이트의 각종 게시판에 게시자가 올린 게시물이 아래과 같은 게시물에 해당되는 경우 관리자는 사전 통지 없이 해당 게시물을 삭제할 수 있으며, 이를 작성한 게시자는 웹사이트의 이용이 차단될 수 있습니다. 또한, 명예훼손 및 저작권침해에 해당 되는 내용에 대해서는 사이버 명예 훼손 분쟁 조정부(<a href="https://www.bj.or.kr" target="_blank">http://www.bj.or.kr</a>) 또는 저작권 보호센터(<a href="https://www.cleancopyright.or.kr" target="_blank">http://www.cleancopyright.or.kr</a>)에 신고될 수 있습니다.</p>
	...
	<?php if(IS_NA_XP) { // 멤버쉽 플러그인 ?>
		<h5 class="text-primary font-weight-bold pt-4 pb-2">4. 레벨별 경험치 안내</h5>
