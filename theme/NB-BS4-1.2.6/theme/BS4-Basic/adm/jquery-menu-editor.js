...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="fa fa-edit fa-lg clickable"></i>',
        labelRemove: '<i class="fa fa-times fa-lg clickable"></i>',
        textConfirmDelete: '메뉴를 삭제하시겠습니까?',
        iconPicker: { cols: 4, rows: 4, footer: false, iconset: "fontawesome4" },
        listOptions: { 
    ...
    function TButtonGroup() {
        ...
        var $btnEdit = TButton({classCss: 'btn btn-success btn-sm btnEdit', text: settings.labelEdit});
        var $btnRemv = TButton({classCss: 'btn btn-danger btn-sm btnRemove', text: settings.labelRemove});
        var $btnUp = TButton({classCss: 'btn btn-secondary btn-sm btnUp btnMove', text: '<i class="fa fa-angle-up fa-lg clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-secondary btn-sm btnDown btnMove', text: '<i class="fa fa-angle-down fa-lg clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-secondary btn-sm btnOut btnMove', text: '<i class="fa fa-level-down fa-lg clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-secondary btn-sm btnIn btnMove', text: '<i class="fa fa-level-up fa-lg clickable"></i>'});
    ...
    this.update = function(){
        ...
        $cEl.children().children('i').removeClass('fa ' + oldIcon).addClass('fa ' + $cEl.data('icon'));
    ...
    this.add = function(){
        ...
        var iconItem = $('<i>').addClass('fa ' + data.icon);
